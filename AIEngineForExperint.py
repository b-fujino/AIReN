...
if __name__ == "__main__":
    ...
    message = [{"role": "user", "content": "自己紹介（名前と職業のみ）を行った上で，インタビューを開始してください．"}]
    ...
    while True:
        ...
        CheckNewInfo = Agent_chat_parsed(
            ...
            message = [{"role": "user", "content": f"[log]：{chatlog4reporter}\n\n [NewAnswer]: {Answer}"}],
            response_model=CheckNewInfo
        )
        print("CheckNewInfo:")
        print(json.dumps(CheckNewInfo.model_dump(), ensure_ascii=False, indent=2))
