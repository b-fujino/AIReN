            ...
            "substeps": [
                {
                    ...
                    # ),
                    "directions":[
                        "事象発生直前の当人の認知状態（例えば，何を見ていたか、何を聞いていたか、何を考えていたか）を尋ねてください． ",
                        "事象発生直前の当人の身体的状態（例えば，疲労度、痛みや不快感のある部位）を尋ねてください。",
                        "事象発生直前の当人の感情状態（例えば，その時にストレスを感じていたか、不安だったか、冷静だったか、またその時の仕事に対する気持ち）を尋ねてください。",
                        #"Ask the reporter whether any special information they had about the task, the equipment, and the situation before the incident or near miss.",
                        "事象発生時の作業に対する当人の経験や、自信の程度について尋ねてください。"
                    ],
                },
                {
                    "substep": 2,
