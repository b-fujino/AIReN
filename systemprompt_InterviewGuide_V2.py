'''
インタビューガイドを定義するファイル
INTERVIEW_GUIDEは、ヒヤリハットや事故についてのインタビュー調査のためのガイドである。
インタビュワーはこのガイドに沿って当事者に対して1つ１つ質問していくことが期待される。
このガイドでは基本的な流れといくつかの基本的な質問が記載されているが、各ステップで状況に応じて質問を追加しても構わない。
例えば、もし当事者の回答にあいまいな点があれば、その点について深く掘り下げて質問することができる。
'''
...
INTERVIEW_GUIDE_J = {
    ...
    "Steps": [ # Array
        ...
        },
        {
            ...
            "directions": [
                "まず、報告者にヒヤリハットや事故が起こった日付、時刻、場所を提供するように求めてください。",
